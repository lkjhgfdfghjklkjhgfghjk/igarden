    ...
    <div className="fixed inset-0 z-[99999] flex items-start justify-center pt-0 sm:pt-16 bg-black/60 backdrop-blur-xs transition-all duration-300">
      ...
      >
        ...
        <div className="p-4 sm:p-5 border-b border-gray-200 flex items-center gap-3">
          <button 
            onClick={onClose}
            className="p-1.5 text-gray-500 hover:text-black rounded-sm hover:bg-gray-100 transition-colors cursor-pointer"
          >
            <ArrowLeft className="w-5 h-5 sm:hidden" />
            <X className="w-5 h-5 hidden sm:block" />
          </button>
          
          <div className="flex-1 relative flex items-center bg-[#F5F5F7] rounded-sm px-3.5 py-2.5">
            ...
            <div className="flex flex-wrap gap-2">
              {hotSearches.map((item, idx) => (
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-sm bg-[#F5F5F7] hover:bg-[#EAEAEA] text-[12px] sm:text-[13px] text-gray-700 transition-colors font-medium cursor-pointer"
                >
