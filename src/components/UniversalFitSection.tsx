    ...
    <section className="py-16 sm:py-24 bg-white overflow-hidden">
      <div className="max-w-[1500px] mx-auto px-4 sm:px-14 mb-10 sm:mb-14 text-center">
        <h2 className="text-[28px] sm:text-[44px] font-bold text-gray-950 font-['Figtree'] leading-tight mb-4">
          Compatibilité universelle avec toutes les piscines.
        </h2>
        <p className="text-[16px] sm:text-[20px] text-gray-600 max-w-[1100px] mx-auto leading-relaxed">
          Conçue pour les bassins dès 2 m × 4 m : la gamme iGarden Swim Jet s'adapte sans travaux aux piscines hors-sol, enterrées, de forme libre, petits bassins, liners ou béton. Aucune contrainte d'espace, aucune modification structurelle requise.
        </p>
      </div>
