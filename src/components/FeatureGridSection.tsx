        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
          ...
          <div className="md:col-span-6 relative rounded-2xl overflow-hidden min-h-[280px] sm:min-h-[380px] shadow-sm group">
            ...
            <div className="absolute top-6 left-6 right-6 text-white">
              <h3 className="text-[22px] sm:text-[28px] font-bold mb-2">{t.features.bento2Title}</h3>
              <p className="text-[15px] sm:text-[17px] text-white/90 leading-relaxed max-w-[500px]">
                {t.features.bento2Desc}
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-6 relative rounded-2xl overflow-hidden min-h-[280px] sm:min-h-[380px] shadow-sm group">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/20 to-black/40" />
            <div className="absolute top-6 left-6 right-6 text-white">
              <h3 className="text-[22px] sm:text-[28px] font-bold mb-2">{t.features.bento1Title}</h3>
              <p className="text-[15px] sm:text-[17px] text-white/90 leading-relaxed max-w-[500px]">
                {t.features.bento1Desc}
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-4 relative rounded-2xl overflow-hidden min-h-[320px] sm:min-h-[460px] shadow-sm group">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/20 to-black/40" />
            <div className="absolute top-6 left-6 right-6 text-white">
              <h3 className="text-[22px] sm:text-[26px] font-bold mb-2">{t.features.bento5Title}</h3>
              <p className="text-[14px] sm:text-[16px] text-white/90">
                {t.features.bento5Desc}
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-4 relative rounded-2xl overflow-hidden min-h-[320px] sm:min-h-[460px] shadow-sm group">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/20 to-black/40" />
            <div className="absolute top-6 left-6 right-6 text-white">
              <h3 className="text-[22px] sm:text-[26px] font-bold mb-2">{t.features.subtitle}</h3>
              <p className="text-[14px] sm:text-[16px] text-white/90">
                {t.features.bento1Desc}
              </p>
            </div>
          ...
          <div className="md:col-span-4 flex flex-col gap-5">
            <div className="relative rounded-2xl overflow-hidden flex-1 min-h-[200px] shadow-sm group">
              ...
              <div className="absolute top-5 left-5 right-5 text-white">
                <h3 className="text-[20px] font-bold mb-1">{t.features.bento4Title}</h3>
                <p className="text-[13px] text-white/90">{t.features.bento4Desc}</p>
              </div>
            </div>
            ...
            <div className="relative rounded-2xl overflow-hidden flex-1 min-h-[200px] shadow-sm group">
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-black/60 to-black/40" />
              <div className="absolute top-5 left-5 right-5 text-white">
                <h3 className="text-[20px] font-bold mb-1">{t.features.bento3Title}</h3>
                <p className="text-[13px] text-white/90">{t.features.bento3Desc}</p>
              </div>
            </div>
          </div>
        </div>
